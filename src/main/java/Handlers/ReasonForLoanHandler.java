...
public class ReasonForLoanHandler implements PromptHandler {
    public static final String LOAN_REASON_PROMPT = "🤖: And what do you need the money for?";
    public static final String LOAN_MOTIVE_PROMPT = "🤖: Home , Car , Holidays, Big Event?";
    public static final String LOAN_OPTIONS_PROMPT = "🤖: Nice, I already have some options for you";
    @Override
