...
public class BirthInformationHandler implements PromptHandler {
    public static final String AGE_PROMPT_SETUP = "🤖: Fantastic. We are 70% done with the setup!";
    public static final String AGE_PROMPT = "🤖: Your age is another important value for finding the best offers. Please enter your date of birth YYYY-MM-DD 📅";
    public static final String UNDER_AGE_PROMPT = "🤖: Sorry, but you seem to be under the legal age of 18.";
